...
from .global_vars import VT2CAP, VEHICLE_TYPE_, RIDE_STATUS_
...
class RegisteredSharer(models.Model):
    registered_sharer_id = models.ForeignKey('MyUser', models.DO_NOTHING, db_column='joined_sharer_id')
    # rideid = models.ForeignKey(Ride, on_delete=models.SET_NULL, db_column='rideid', null=True)
...
class Ride(models.Model):
    ...
    ride_status = models.CharField(max_length=10, choices=RIDE_STATUS_, blank=True, default='opn')
    ...
    share_id = models.ForeignKey('MyUser', models.DO_NOTHING, db_column='sharer', null=True, blank=True)
...
class Vehicle(models.Model):
    ...
    plate_num = models.CharField(primary_key=True, max_length=10)
